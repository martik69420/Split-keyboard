...
## Where I Bought Parts

- nice!nano: ADD STORE / LINK  
- Choc switches: ADD STORE / LINK  
- Choc keycaps: ADD STORE / LINK  
- Diodes: ADD STORE / LINK  
- Battery + JST: ADD STORE / LINK  
- Power + reset switches: ADD STORE / LINK  
